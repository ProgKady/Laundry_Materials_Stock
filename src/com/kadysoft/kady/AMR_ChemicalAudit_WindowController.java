 ...
 * @author KADY
 */
public class AMR_ChemicalAudit_WindowController implements Initializable {
    ...
    @FXML
    private JFXTextField rownumber,columnname,celldata;
    ...
    void tableaction(MouseEvent event) {
      ...
      int idd=(int) datatable.getSelectionModel().getSelectedIndices().get(0);
      int iddd=idd+1;
    ...
    if (value3.contains("0")||value3.contains("1")||value3.contains("2")||value3.contains("3")||value3.contains("4")||value3.contains("5")||value3.contains("6")||value3.contains("7")||value3.contains("8")||value3.contains("9")) {
      ...
      noti.text("Sorry. you can't modify values or dates here, call the admin Ahmed Elkady to modify from database.\nPowered by Kadysoft Ltd.");
      ...
      noti.showWarning();
            ...
            try {
                ...
                String sqloo= "update Audit set ID="+value1+", "+value2+"="+value3+" where ID="+value1+"";
                pstt=connn.prepareStatement(sqloo);
                pstt.execute();
