...
public class ConsumptionController implements Initializable {
    ...
    void consumaction(ActionEvent event) {
      ...
      myuser1.getItems().addAll("Input","Output");
 ...
 @Override public LocalDate fromString(String string) {
    ...
    getClass().getResource("primer-dark.css").toExternalForm());
      ...
      if (option2.get() == null) {con.setVisible(true);
        con1.setVisible(false);} 
          ...
          if (myuser2.getSelectionModel().getSelectedItem()==null) {
            ...
            String sql ="SELECT Date, Material_Name, SUM(Quantity),Price , SUM(Total_Consumption) FROM Consumption WHERE Status='"+mu1+"' AND (Date) BETWEEN ('"+do1+"') AND ('"+do2+"') GROUP BY Material_Name ORDER BY SUM(Total_Consumption) "+mu2+" LIMIT "+limt+"";
      ...
      //      JOptionPane.showMessageDialog(null, e);
            ...
            String sql ="SELECT Date, Material_Name, SUM(Quantity),Price , SUM(Total_Consumption) FROM Consumption WHERE Status='"+mu1+"' AND (Date) BETWEEN ('"+do1+"') AND ('"+do2+"') GROUP BY Material_Name ORDER BY SUM(Total_Consumption) "+mu2+"";
            pst=conn.prepareStatement(sql);  
            rs=pst.executeQuery();
      ...
      //      JOptionPane.showMessageDialog(null, e);
            ...
            String sql ="SELECT Date, Material_Name, SUM(Quantity),Price , SUM(Total_Consumption) FROM Consumption WHERE Status='"+mu1+"' AND strftime('%Y-%m', Date) = '"+doo2+"-"+doo1+"' GROUP BY Material_Name ORDER BY SUM(Total_Consumption) "+mu2+" LIMIT "+limt+"";
            pst=conn.prepareStatement(sql);  
            rs=pst.executeQuery();
      ...
      //      JOptionPane.showMessageDialog(null, e);
            ...
            String sql ="SELECT Date, Material_Name, SUM(Quantity),Price , SUM(Total_Consumption) FROM Consumption WHERE Status='"+mu1+"' AND strftime('%Y-%m', Date) = '"+doo2+"-"+doo1+"' GROUP BY Material_Name ORDER BY SUM(Total_Consumption) "+mu2+"";
            pst=conn.prepareStatement(sql);  
            rs=pst.executeQuery();
      ...
      //      JOptionPane.showMessageDialog(null, e);
            ...
            String sql ="SELECT Date, Material_Name, SUM(Quantity),Price , SUM(Total_Consumption) FROM Consumption WHERE Status='"+mu1+"' AND Date >='"+dooo1+"-01-01' AND Date <='"+dooo1+"-12-31' GROUP BY Material_Name ORDER BY SUM(Total_Consumption) "+mu2+" LIMIT "+limt+"";
            pst=conn.prepareStatement(sql);  
            rs=pst.executeQuery();
      ...
      //      JOptionPane.showMessageDialog(null, e);
            ...
            String sql ="SELECT Date, Material_Name, SUM(Quantity),Price , SUM(Total_Consumption) FROM Consumption WHERE Status='"+mu1+"' AND Date >='"+dooo1+"-01-01' AND Date <='"+dooo1+"-12-31' GROUP BY Material_Name ORDER BY SUM(Total_Consumption) "+mu2+"";
            pst=conn.prepareStatement(sql);  
            rs=pst.executeQuery();
...
//       double total=0.0;   
//       for (int i= 0;i<datatable.getItems().size();i++){
//           total = total+Integer.valueOf(String.valueOf(datatable.getColumns().get(7).getCellObservableValue(i).getValue()));
//           }
