 ...
 * @author ahmed.elkady
 */
public class IndexesController implements Initializable {
      ...
      noti.showError();
          ...
          /////////////////KADY///////////////
           ...
           try {
            ...
            pst.setString(2,supplierr);
            pst.setString(3,materialnamee);
            pst.setString(4,unitt);
            pst.setString(5,unitpricee);
...
DialogPane dialogPaneef = alert.getDialogPane();
    ...
    void itemcoderel(KeyEvent event) {
      ...
      this.pst = this.conn.prepareStatement(sql);
      this.pst.setString(1, this.itemcode.getText());
      this.rs = this.pst.executeQuery();
      String add2 = this.rs.getString("Material_Name");
      this.itemname.setText(add2);
      String add3 = this.rs.getString("Unit_Price");
    ...
    void updatepricebtnaction(ActionEvent event) {
        ...
        only=new JFXRadioButton("Index Only.");
        only.setSelected(false);
        only.setToggleGroup(tg);
        both=new JFXRadioButton("Index And Stock.");
...
DialogPane dialogPaneef = alert.getDialogPane();
      ...
      this.pst = this.conn.prepareStatement(sqlo);
      this.pst.setString(1, this.itemcode.getText());
      this.rs = this.pst.executeQuery();
      
      String add2 = this.rs.getString("Stock");
